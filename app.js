...
const FALLBACK_PEOPLE = [
  {first_name:"Taryn", last_name:"Swayze", title:"Packaging Engineer", organization:"Highlight Industries, Inc.", phone:"616-531-2464 x242", email:"tarynm@highlightindustries.com", website:"https://www.highlightindustries.com", slug:"taryn-swayze"},
  {first_name:"Jessica", last_name:"Flanders", title:"E-commerce & Inventory Administrator", organization:"Highlight Industries, Inc.", phone:"616-531-2464 x000", email:"jessica.flanders@highlightindustries.com", website:"https://www.highlightindustries.com", slug:"jessica-flanders"}
];
...
async function main(){
  ...
  try{
    ...
    const msg = "Could not load employees.csv (" + (err && err.message ? err.message : "unknown error") + "). Using fallback demo data.";
